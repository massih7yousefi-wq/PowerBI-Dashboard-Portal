    ...
    public partial class AddDashboardFeatures : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BiTasks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Definition = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BiTasks_DueDate",
                table: "BiTasks",
                column: "DueDate");

            migrationBuilder.CreateIndex(
                name: "IX_BiTasks_Priority",
                table: "BiTasks",
                column: "Priority");

            migrationBuilder.CreateIndex(
                name: "IX_BiTasks_Status",
                table: "BiTasks",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_ProjectId",
                table: "Favorites",
